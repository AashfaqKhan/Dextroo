  ...
  const handleAnalyze = async () => {
    ...
    try {
      const analysis = await analyzeImage(
        ...
        selectedFile.type,
        prompt ||
          "Identify the main subjects and explain the educational value of this image."
      );
    ...
    <div className="flex flex-col h-full space-y-6">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <p className="text-gray-600 mb-6">
          Upload an educational image, diagram, or chart, and our AI will
          analyze it for you.
        </p>
      ...
      {previewUrl && (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 min-h-[200px]">
          {/* min-h-[200px] sets a larger minimum height */}
      ...
      {result && (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex-1 overflow-auto min-h-[200px]">
