...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  const handleDeleteFaculty = async (username: string) => {
    if (
      window.confirm(
        `Are you sure you want to remove faculty member ${username}?`
      )
    ) {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      {/* Desktop Sidebar */}
      <div className="hidden md:flex w-64 bg-gray-900 text-white flex-col shadow-2xl">
        ...
        <div className="p-4 border-t border-gray-800 bg-gray-900">
          <div className="flex items-center mb-4 px-2">
            <div className="h-9 w-9 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center font-bold text-sm shadow-md">
              A
            </div>
            <div className="ml-3">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          ></div>
          <div className="relative flex-1 flex flex-col w-64 bg-gray-900 text-white shadow-2xl">
      ...
      <div className="flex-1 overflow-auto flex flex-col">
        ...
        {/* Mobile Navigation */}
        <div className="md:hidden bg-white border-b border-gray-200 overflow-x-auto whitespace-nowrap p-3 flex gap-2 sticky top-16 z-30">
          <button
            onClick={() => setCurrentView("students")}
          ...
          {currentView !== "timetable" && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
              <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 flex items-center">
                <div className="p-2 md:p-3 bg-blue-100 rounded-lg mr-3 md:mr-4 text-blue-600">
              ...
              <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 flex items-center">
                <div className="p-2 md:p-3 bg-teal-100 rounded-lg mr-3 md:mr-4 text-teal-600">
              ...
              <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 flex items-center">
                <div className="p-2 md:p-3 bg-purple-100 rounded-lg mr-3 md:mr-4 text-purple-600">
          ...
          {currentView === "students" && (
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="px-4 md:px-6 py-4 md:py-5 border-b border-gray-200 bg-white flex justify-between items-center">
                <h3 className="text-gray-800 font-bold flex items-center text-sm md:text-lg">
              ...
              {students.length === 0 ? (
                <div className="p-8 md:p-16 text-center">
                  ...
                  <p className="mt-1 text-gray-500">
                    Registration data will appear here once students sign up.
                  </p>
                </div>
              ) : (
                      ...
                      {students.map((student, idx) => (
                        ...
                        >
                          <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="h-8 w-8 md:h-10 md:w-10 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-sm shadow-sm">
                          ...
                          <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                            {student.feeScreenshot ? (
                              <button
                                onClick={() =>
                                  setSelectedImage(student.feeScreenshot)
                                }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 md:p-8">
                ...
                <form
                  ...
                  className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-end"
                >
                ...
                {facError && (
                  <p className="mt-4 text-sm text-red-600 bg-red-50 p-3 rounded-md font-medium border border-red-100 inline-block">
                    {facError}
                  </p>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="px-4 md:px-6 py-4 md:py-5 border-b border-gray-200 bg-white">
                  <h3 className="text-gray-800 font-bold flex items-center text-sm md:text-lg">
                    <Shield className="w-4 h-4 md:w-5 md:h-5 mr-2 text-indigo-500" />{" "}
                    Authenticated Staff
                  </h3>
                </div>
                {faculty.length === 0 ? (
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50/50">
                        <tr>
                          ...
                          <th className="px-4 md:px-6 py-3 md:py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">
                            Actions
                          </th>
                        </tr>
                      </thead>
                      <tbody className="bg-white divide-y divide-gray-200">
                        {faculty.map((member, idx) => (
                          ...
                          >
                            <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <div className="h-8 w-8 md:h-10 md:w-10 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center font-bold text-sm">
                            ...
                            <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                <span className="px-2 py-1 bg-gray-100 rounded text-sm font-mono text-gray-700 mr-2 truncate max-w-[120px] md:max-w-none">
                                  {member.password}
                                </span>
                                <button
                                  onClick={() =>
                            ...
                            <td className="px-4 md:px-6 py-4 whitespace-nowrap text-right">
                              <button
                                onClick={() =>
                                  handleDeleteFaculty(member.username!)
                                }
                                className="text-red-600 hover:text-red-900 hover:bg-red-50 p-1.5 md:p-2 rounded-full transition-colors"
                                title="Revoke Access"
                              >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 md:p-8">
                ...
                <form
                  ...
                  className="space-y-4 md:grid md:grid-cols-12 md:gap-6 items-end"
                >
                  <div className="md:col-span-3">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Subject / Course
                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <LinkIcon className="h-3 w-3 md:h-4 md:w-4 text-gray-400" />
                      </div>
                      <input
                        type="text"
                        value={classLink}
                  ...
                  <div className="md:col-span-3">
                    ...
                    >
                      <Plus className="w-3 h-3 md:w-4 md:h-4 mr-2" /> Add
                      Schedule
                    </button>
                  </div>
                </form>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="px-4 md:px-6 py-4 md:py-5 border-b border-gray-200 bg-white">
                  <h3 className="text-gray-800 font-bold flex items-center text-sm md:text-lg">
                    <Clock className="w-4 h-4 md:w-5 md:h-5 mr-2 text-indigo-500" />{" "}
                    Master Schedule
                  </h3>
                </div>
                ...
                {daysOfWeek.map((day) => {
                  ...
                  return (
                    ...
                    >
                      <div className="bg-gray-50 px-4 md:px-6 py-2 text-xs font-bold text-gray-500 uppercase tracking-wide">
                        {day}
                      </div>
                      <div className="grid grid-cols-1 xl:grid-cols-2 gap-0">
                        {dayClasses.map((session) => (
                          <div
                            key={session.id}
                            className="px-4 md:px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 transition-colors border-b border-gray-100 xl:border-r xl:even:border-r-0"
                          >
                            <div className="flex items-start gap-3 md:gap-4 mb-3 sm:mb-0">
                              <div className="px-2 py-1.5 md:px-3 md:py-2 bg-indigo-50 text-indigo-700 rounded-lg text-xs md:text-sm font-mono font-bold whitespace-nowrap border border-indigo-100">
                            ...
                            <div className="self-end sm:self-center">
                              <button
                                ...
                                className="text-red-500 hover:bg-red-50 p-1.5 md:p-2 rounded-lg transition-colors flex items-center text-xs font-medium"
                              >
      ...
      {selectedImage && (
        ...
        >
          <div
            className="bg-white rounded-2xl overflow-hidden max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl animate-scale-in"
          ...
          >
            <div className="p-4 md:p-5 border-b border-gray-200 flex justify-between items-center bg-gray-50">
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="text-gray-400 hover:text-gray-700 bg-white p-1 rounded-full border border-gray-200 hover:bg-gray-100"
              >
                <X className="w-4 h-4 md:w-5 md:h-5" />
              </button>
            </div>
            <div className="overflow-auto p-4 md:p-8 flex justify-center bg-gray-100/50">
              <img
                src={selectedImage}
                alt="Fee Screenshot"
                className="max-w-full h-auto shadow-md rounded-lg border border-gray-200"
              />
            </div>
            <div className="p-4 border-t border-gray-200 flex justify-end bg-gray-50">
              <button
                onClick={() => setSelectedImage(null)}
                className="px-4 md:px-5 py-2 md:py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 text-sm font-medium transition-colors"
              >
                Close Viewer
              </button>
            </div>
